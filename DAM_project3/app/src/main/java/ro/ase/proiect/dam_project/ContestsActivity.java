...
public class ContestsActivity extends AppCompatActivity {
    ...
    private void initComponents()
    {
        ...
        btnChart = findViewById(R.id.contests_btn_chart);
        ...
        btnChart.setOnClickListener(goToChartActivity());

    }



    private View.OnClickListener goToChartActivity(){
    ...
    private AdapterView.OnItemClickListener onListItemClick() {
        return new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                intent.putExtra(Constants.CONTEST_ID, selectedContest.getId());
                intent.putExtra(Constants.CONTEST_NAME, selectedContest.getName());
                intent.putExtra(Constants.CONTEST_DESCRIPTION, selectedContest.getDescription());
                intent.putExtra(Constants.CONTEST_CODE, selectedContest.getCode());
